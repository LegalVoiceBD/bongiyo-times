...
export default async function NewsDetail({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-white text-black tracking-tight">
      ...
      {/* Footer Section */}
      <footer className="bg-white border-t-4 border-red-700 pt-8 pb-6 text-black text-center mt-10">
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <div className="mb-6 space-y-2">
             <p className="text-[18px] font-bold text-gray-900">সম্পাদক ও প্রকাশক : অ্যাডভোকেট মো: আজাদুর রহমান</p>
